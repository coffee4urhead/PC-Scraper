...
class AmazonComScraper(PlaywrightBaseScraper):
    ...
    def _extract_product_data(self, page, product_url):
        ...
        try:
            ...
            if price_element_whole and price_element_fraction:
                ...
                price_text = f"${whole_part}.{fraction_part}"  # This is already a string, no need for inner_text()
            else:
                price_text = "N/A"
            ...
            print(f"DEBUG: Extracted Amazon.com product: {title} - {price}")
