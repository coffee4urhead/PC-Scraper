...
class PlasicoScraper(PlaywrightBaseScraper):
    ...
    def _construct_page_url(self, base_url, search_term, page):
        if page > 1:
            return f"{self.base_url}tyrsene/{quote(search_term)}/p{page}"
        return base_url
    ...
    def _extract_product_links(self, page, page_url):
        ...
        try:
            ...
            page.wait_for_selector('div#list-results', timeout=10000)

            product_elements = page.query_selector_all('div#list-results')
            ...
            for product in product_elements:
                ...
                title_element = product.query_selector('span.ttl')
                ...
                link_element = product.query_selector('a.mainlink[href]')
                if link_element:
    ...
    def _parse_product_page(self, page, product_url):
        ...
        try:
            ...
            page.wait_for_selector('div.details-heading h1', timeout=10000)

            title_element = page.query_selector('div.details-heading h1')
            ...
            tech_table = page.query_selector('table#spec-table')
            if tech_table:
                    ...
                    try:
                        ...
                        if len(td_elements) >= 2:
                            ...
                            if value:
                                ...
                                print(f"DEBUG: Added Plasico spec: {label} = {value}")
                        else:
